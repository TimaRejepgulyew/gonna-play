  ...
  return (
    <MenubarPrimitive.Trigger
      ...
      className={cn(
        ...
        value === itemValue ? "bg-accent text-accent-foreground" : undefined,
        className
      )}
      {...props}
    />
  ...
  return (
    <TextClassContext.Provider
      value={cn(
        ...
        open ? "native:text-accent-foreground" : undefined
      )}
    >
  ...
  <TextClassContext.Provider value="select-none text-sm native:text-lg text-popover-foreground web:group-focus:text-accent-foreground">
    <MenubarPrimitive.Item
      ...
      className={cn(
        ...
        inset ? "pl-8" : undefined,
        props.disabled ? "opacity-50 web:pointer-events-none" : undefined,
        className
      )}
      {...props}
    />
...
>(({ className, children, checked, ...props }, ref) => (
  <MenubarPrimitive.CheckboxItem
    ...
    className={cn(
      ...
      props.disabled ? "web:pointer-events-none opacity-50" : undefined,
      className
    )}
    checked={checked}
    {...props}
